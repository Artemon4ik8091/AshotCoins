...
void main()
{
	setlocale(LC_ALL, "russian");
		cout << "-------------------------------------------" << endl;
		cout << "Банк для Ашоткойнов. Version: 0.0.3.9 Alpha" << endl;
		cout << "-------------------------------------------" << endl;
	do
	{
		...
		if (buffer == l1 && buffer2 == p1)
		{
			...
			while (true)
			{
				...
				else if (buffer == 5)
				{
					...
					cout << "Версия приложения: 0.0.3.9_Alpha" << endl;
					cout << "-------------------------------" << endl;
					cout << endl;
					cout << "-----------------------------------------" << endl;
		...
		else if (buffer == dev || buffer2 == dev)
		{
			...
			cout << "\"Ashotcoins\" app version 0.0.3.9 Alpha" << endl;
			...
			cout << "Security...in developing" << endl;
			cout << "----------------------------------------" << endl;
			restart = 1;
